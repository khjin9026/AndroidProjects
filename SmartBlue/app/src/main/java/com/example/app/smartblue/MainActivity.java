...
public class MainActivity extends AppCompatActivity {
    //클래스변수 선언
    BluetoothAdapter mBluetoothAdapter; //m : 멤버변수 , 어뎁터:블루투스 소켓이 연결되는 것
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "액티비티 생성", Toast.LENGTH_LONG).show();
        ...
        btnConnect.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { //람다식으로 축약되어 있음
                try {
                    findBT();
                    stat = 1;
                } catch (IOException e) {
